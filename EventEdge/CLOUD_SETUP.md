...
- YDB не имеет зарезервированной мощности, ограничена 100 RU/с и 1 ГБ, защищена от удаления. Лимит RU/с разрешает короткий burst для чтения Evals, но не резервирует платную мощность.
