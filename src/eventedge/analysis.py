...
CURRENT_NEWS_MODEL_VERSION = "signal-engine-0.6.0"
...
class BaselineSignal(BaseModel):
    ...
    model_version: Literal["signal-engine-0.6.0"]
    config_version: int
...
class BaselineScoringConfig(BaseModel):
    ...
    model_version: Literal["signal-engine-0.6.0"] = "signal-engine-0.6.0"
...
EVENT_RULES: tuple[tuple[EventType, tuple[str, ...], float], ...] = (
    ...
    (
        ...
        ("господдерж", "субсиди", "выделени", "поддержк"),
        0.72,
    ),
    (
